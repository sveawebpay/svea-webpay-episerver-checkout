...
using Svea.WebPay.Episerver.Checkout.OrderManagement.Events;

namespace Svea.WebPay.Episerver.Checkout.OrderManagement.Initalization
{
    [InitializableModule]
    ...
    internal class OrderInitalization : IInitializableModule
    {
        ...
        private void Current_OrderGroupUpdated(object sender, OrderGroupEventArgs e)
        {
            ...
            if (orderAfterSave.OrderStatus.Equals(OrderStatus.Cancelled))
            {
